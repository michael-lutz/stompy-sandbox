...
class StompyWalkEnv(MujocoEnv, utils.EzPickle):
    r"""
    ## Description
    ...
    * v0: Initial versions release
    ...
    stompy_dir = os.path.join(os.path.dirname(__file__), "assets/stompy.xml")
    def __init__(
        self,
        xml_file: str = stompy_dir,
        frame_skip: int = 5,
        ...
        healthy_z_range: Tuple[float, float] = (0.1, 2.0),
    ...
    def is_healthy(self):
        ...
        print(self.data.qpos[0], self.data.qpos[1], self.data.qpos[2])
